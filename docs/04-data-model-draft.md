...
Task 10의 초기 PoC 대화 API는 단발성 요청으로 구현하며 Conversation과 ConversationMessage를 아직 생성하거나 저장하지 않는다. 대화 이력과 보존 기간이 실제 화면 요구사항으로 확정되면 두 구조를 다시 검토한다.
